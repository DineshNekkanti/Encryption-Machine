...
import java.util.*;
//This is the program of Caesar Cipher. 
//This contains both the encryption of the plain text to cipher text and vice versa.
...
public class EncryptionMachine 
{
    public static void main(String args[]) 
    {
        ...
        //The key here is the value by which the program will shift the letters.
        //If key is 3, then the program will shift the values by 3 letters.
